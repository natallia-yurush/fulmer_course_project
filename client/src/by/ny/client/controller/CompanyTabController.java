...
public class CompanyTabController {
    ...
    public void reloadCompaniesTableData() {
        ...
        try {
            ...
            outputStream.writeObject(new Request(RequestType.COMPANIES_LIST, CurrentUserUtil.getCurrentUser().getId()));
    ...
    public void saveButtonAction() {
        ...
        try {
            ...
            outputStream.writeObject(new Request(RequestType.SAVE_COMPANY, new Company(id, nameField.getText(), addressField.getText(),
    ...
    public void deleteButtonAction() {
        ...
        try {
            ...
            ObjectOutputStream outputStream = new ObjectOutputStream(socket.getOutputStream());
            outputStream.writeObject(new Request(RequestType.DELETE_COMPANY, selectedCompany.getId()));
